...
public sealed partial class AccessibilityTab : Control
{
    public AccessibilityTab()
    {
        ...
        // Far Horizons start
        Control.AddOptionColorSlider(FHCCVars.HostileTelegraphsColor, HostileTelegraphsColorSlider);
        Control.AddOptionColorSlider(FHCCVars.UtilityTelegraphsColor, UtilityTelegraphsColorSlider);
        // Far Horizons end
