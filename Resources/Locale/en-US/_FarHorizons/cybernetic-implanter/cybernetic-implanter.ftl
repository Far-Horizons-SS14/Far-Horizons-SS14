comp-usedcyberneticimplanter-examine = The gored remains of a [bold]{$species} {$organ}[/bold] can be seen inside
...
comp-cyberneticimplanter-organdestroyed = The {$implanter} gores the {$destroyed} of {$target}!