...
namespace Content.Shared.Preferences
{
    ...
    public sealed partial class HumanoidCharacterProfile : ICharacterProfile
    {
        ...
        public void AssertEquals(ICharacterProfile maybeOther)
        {
            ...
            if (!_factionJobPreferences.SequenceEqual(other._factionJobPreferences)) throw new DebugAssertException($"_jobPreferences doesn't match expected '{_factionJobPreferences}' got '{other._factionJobPreferences}'");;
